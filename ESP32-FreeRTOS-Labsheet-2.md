...
#### แสดงผล Hello My First Task โดยจะมีการแสดงผลค่าตัวเลขซ้ำกันตามจำนวนคำสั่งที่ใส่ใน app_main เมื่อครบตามคำสั่งแล้วตัวเลขต่อท้ายที่เพิ่มขึ้น 1 ค่า เมื่อขึ้นบรรทัดใหม่
